    ...
    <div className='ms-5'>
            ...
            <div className='row mt-4'>
                ...
                <div className="col-lg-6">
                        ...
                        <select className='w-75 form-select' aria-label="Default select example"  onChange={e=>setStudentdata({...studentData,gender:e.target.value})}>
                ...
                <div className="col-lg-6">
                    ...
                    <Form.Label> Course</Form.Label>
                        <Form.Select aria-label="Default select example"  onChange={e=>setStudentdata({...studentData,course:e.target.value})}>
